package acr.browser.presearch.preference

import acr.browser.presearch.AppTheme
import acr.browser.presearch.browser.ProxyChoice
import acr.browser.presearch.browser.SearchBoxDisplayChoice
import acr.browser.presearch.browser.SearchBoxModel
import acr.browser.presearch.constant.DEFAULT_ENCODING
import acr.browser.presearch.constant.SCHEME_HOMEPAGE
import acr.browser.presearch.device.ScreenSize
import acr.browser.presearch.di.UserPrefs
import acr.browser.presearch.preference.delegates.*
import acr.browser.presearch.search.SearchEngineProvider
import acr.browser.presearch.search.engine.GoogleSearch
import acr.browser.presearch.utils.FileUtils
import acr.browser.presearch.view.RenderingMode
