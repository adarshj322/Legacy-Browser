...
import acr.browser.presearch.browser.*
...
import acr.browser.presearch.browser.tabs.TabsDesktopView
import acr.browser.presearch.browser.tabs.TabsDrawerView
import acr.browser.presearch.controller.UIController
import acr.browser.presearch.database.Bookmark
import acr.browser.presearch.database.HistoryEntry
import acr.browser.presearch.database.SearchSuggestion
import acr.browser.presearch.database.WebPage
...
import acr.browser.presearch.di.*
import acr.browser.presearch.dialog.BrowserDialog
import acr.browser.presearch.dialog.DialogItem
import acr.browser.presearch.dialog.LightningDialogBuilder
import acr.browser.presearch.extensions.*
...
import acr.browser.presearch.interpolator.BezierDecelerateInterpolator
import acr.browser.presearch.log.Logger
import acr.browser.presearch.notifications.IncognitoNotification
...
import acr.browser.presearch.ssl.SslState
import acr.browser.presearch.ssl.createSslDrawableForState
import acr.browser.presearch.ssl.showSslDialog
import acr.browser.presearch.utils.*
import acr.browser.presearch.view.*
import acr.browser.presearch.view.SearchView
import acr.browser.presearch.view.find.FindResults
...
abstract class BrowserActivity : ThemableBrowserActivity(), BrowserView, UIController, OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val sharedPref = this.getSharedPreferences(
                getString(R.string.register_key), MODE_PRIVATE) ?: return
        var isFirst = sharedPref.getBoolean(getString(R.string.register_key), true)
        if (isFirst) {
            with (sharedPref.edit()) {
                putBoolean(getString(R.string.register_key), false)
                apply()
            }
            val browserInt = Intent(Intent.ACTION_VIEW, Uri.parse("https://presearch.org/signup?rid=1061583"))
