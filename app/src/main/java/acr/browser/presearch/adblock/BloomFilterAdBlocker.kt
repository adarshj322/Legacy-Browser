package acr.browser.presearch.adblock

import acr.browser.presearch.R
import acr.browser.presearch.adblock.source.HostsDataSourceProvider
import acr.browser.presearch.adblock.source.HostsResult
import acr.browser.presearch.adblock.util.BloomFilter
import acr.browser.presearch.adblock.util.DefaultBloomFilter
import acr.browser.presearch.adblock.util.DelegatingBloomFilter
import acr.browser.presearch.adblock.util.`object`.JvmObjectStore
import acr.browser.presearch.adblock.util.`object`.ObjectStore
import acr.browser.presearch.adblock.util.hash.MurmurHashHostAdapter
import acr.browser.presearch.adblock.util.hash.MurmurHashStringAdapter
import acr.browser.presearch.database.adblock.Host
import acr.browser.presearch.database.adblock.HostsRepository
import acr.browser.presearch.database.adblock.HostsRepositoryInfo
import acr.browser.presearch.di.DatabaseScheduler
import acr.browser.presearch.di.MainScheduler
import acr.browser.presearch.extensions.toast
